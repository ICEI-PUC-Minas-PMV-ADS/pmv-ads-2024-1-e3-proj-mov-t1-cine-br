...
Definição de como o software é estruturado em termos dos componentes que fazem parte da solução e do ambiente de hospedagem da aplicação. A aplicação irá gerenciar varios cinemas para que o cliente ter uma flexibilidade de poder comprar na comodidade de sua residencia
